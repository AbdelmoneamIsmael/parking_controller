...
abstract class AppLocalizations {
  ...
  /// No description provided for @please_enter_valid_confirm_password.
  ///
  /// In en, this message translates to:
  /// **'Please enter a valid confirm password'**
  String get please_enter_valid_confirm_password;
  ...
  /// No description provided for @please_select_theme.
  ///
  /// In en, this message translates to:
  /// **'Please select a theme'**
  String get please_select_theme;
